...
public class rodent_vr : ModuleRules
{
	...
	public rodent_vr(ReadOnlyTargetRules Target) : base(Target)
	{
	...
	//	PublicIncludePaths.Add(Path.Combine(ThirdPartyPath, "Binaries", "Win64", nidaq + ".h"));
	//	PublicAdditionalLibraries.Add(Path.Combine(ThirdPartyPath, "Binaries", "Win64"));
	//	return true;
	//}
