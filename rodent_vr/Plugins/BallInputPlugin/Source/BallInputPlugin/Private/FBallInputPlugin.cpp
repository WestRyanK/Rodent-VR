#include "BallInputPluginPrivatePCH.h"

#include "IBallInputPlugin.h"
#include "FBallInputPlugin.h"
#include "SlateBasics.h"

IMPLEMENT_MODULE(FBallInputPlugin, BallInputPlugin)

#define LOCTEXT_NAMESPACE "BallInputPlugin"
...
//Init and Runtime
void FBallInputPlugin::StartupModule()
{
...
void FBallInputPlugin::ShutdownModule()
{
}
...
void FBallInputPlugin::PressButton(int button)
{
...
void FBallInputPlugin::ReleaseButton(int button)
{
	FKey key = GetFKeyForButtonID(button);
	if (key != EKeysCIM::Unknown)
	{
...
void FBallInputPlugin::SetAxisValue(int axisID, float value)
{
