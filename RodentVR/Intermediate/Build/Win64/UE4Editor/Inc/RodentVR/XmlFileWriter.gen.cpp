...
#include "RodentVR/Private/Settings/XmlFileWriter.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UXmlFileWriter_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "Settings/XmlFileWriter.h" },
		{ "ModuleRelativePath", "Private/Settings/XmlFileWriter.h" },
	};
#endif
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UXmlFileWriter_Statics::ClassParams = {
		...
		0,
		0x000000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UXmlFileWriter_Statics::Class_MetaDataParams, ARRAY_COUNT(Z_Construct_UClass_UXmlFileWriter_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UXmlFileWriter, 1089742034);
