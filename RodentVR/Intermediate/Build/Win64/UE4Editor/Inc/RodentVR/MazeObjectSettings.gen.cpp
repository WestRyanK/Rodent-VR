...
// End Cross Module References
	...
	DEFINE_FUNCTION(UMazeObjectSettings::execGetTextureFileName)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UMazeObjectSettings::execSetTextureFileName)
	{
	...
	void UMazeObjectSettings::StaticRegisterNativesUMazeObjectSettings()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetTextureFileName", &UMazeObjectSettings::execGetTextureFileName },
			{ "SetCanCollide", &UMazeObjectSettings::execSetCanCollide },
			{ "SetObjectType", &UMazeObjectSettings::execSetObjectType },
			{ "SetTextureFileName", &UMazeObjectSettings::execSetTextureFileName },
		};
	...
	struct Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics
	{
		struct MazeObjectSettings_eventGetTextureFileName_Parms
		{
			FString ReturnValue;
		};
		static const UE4CodeGen_Private::FStrPropertyParams NewProp_ReturnValue;
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MazeObjectSettings_eventGetTextureFileName_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::Function_MetaDataParams[] = {
		{ "BlueprintGetter", "" },
		{ "ModuleRelativePath", "Private/Settings/MazeObjectSettings.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMazeObjectSettings, nullptr, "GetTextureFileName", nullptr, nullptr, sizeof(MazeObjectSettings_eventGetTextureFileName_Parms), Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	struct Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics
	{
		struct MazeObjectSettings_eventSetTextureFileName_Parms
		{
	...
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::NewProp_TextureFileNameValue = { "TextureFileNameValue", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(MazeObjectSettings_eventSetTextureFileName_Parms, TextureFileNameValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::NewProp_TextureFileNameValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::Function_MetaDataParams[] = {
		{ "BlueprintSetter", "" },
		{ "ModuleRelativePath", "Private/Settings/MazeObjectSettings.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMazeObjectSettings, nullptr, "SetTextureFileName", nullptr, nullptr, sizeof(MazeObjectSettings_eventSetTextureFileName_Parms), Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMazeObjectSettings_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMazeObjectSettings_GetTextureFileName, "GetTextureFileName" }, // 1243604156
		...
		{ &Z_Construct_UFunction_UMazeObjectSettings_SetTextureFileName, "SetTextureFileName" }, // 3596603466
	};
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UMazeObjectSettings_Statics::NewProp_TextureFileName_MetaData[] = {
...
#endif
	const UE4CodeGen_Private::FStrPropertyParams Z_Construct_UClass_UMazeObjectSettings_Statics::NewProp_TextureFileName = { "TextureFileName", nullptr, (EPropertyFlags)0x0040000000000004, UE4CodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UMazeObjectSettings, TextureFileName), METADATA_PARAMS(Z_Construct_UClass_UMazeObjectSettings_Statics::NewProp_TextureFileName_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UMazeObjectSettings_Statics::NewProp_TextureFileName_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UMazeObjectSettings_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UMazeObjectSettings_Statics::NewProp_TextureFileName,
	...
	IMPLEMENT_CLASS(UMazeObjectSettings, 520543206);
