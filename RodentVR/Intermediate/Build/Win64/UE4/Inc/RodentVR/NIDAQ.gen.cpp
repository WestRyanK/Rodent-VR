...
// End Cross Module References
	DEFINE_FUNCTION(UNIDAQ::execinit_NIDAQ)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		UNIDAQ::init_NIDAQ();
	...
	DEFINE_FUNCTION(UNIDAQ::execcontrol_NIDAQ)
	{
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_UNIDAQ_control_NIDAQ_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UNIDAQ, nullptr, "control_NIDAQ", nullptr, nullptr, sizeof(NIDAQ_eventcontrol_NIDAQ_Parms), Z_Construct_UFunction_UNIDAQ_control_NIDAQ_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UNIDAQ_control_NIDAQ_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UNIDAQ_control_NIDAQ_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UNIDAQ_control_NIDAQ_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UNIDAQ_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UNIDAQ_control_NIDAQ, "control_NIDAQ" }, // 1980079021
		{ &Z_Construct_UFunction_UNIDAQ_init_NIDAQ, "init_NIDAQ" }, // 1031325761
	};
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UNIDAQ_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UNIDAQ_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UNIDAQ_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(UNIDAQ, 710630282);
