...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_RodentVR_PageEnum_Hash() { return 1186143840U; }
	UEnum* Z_Construct_UEnum_RodentVR_PageEnum()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "PageEnum::BEHAVIORAL_ANALYSIS", (int64)PageEnum::BEHAVIORAL_ANALYSIS },
				{ "PageEnum::EXIT", (int64)PageEnum::EXIT },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				{ "BEHAVIORAL_ANALYSIS.DisplayName", "Behavioral Analysis" },
				{ "BEHAVIORAL_ANALYSIS.Name", "PageEnum::BEHAVIORAL_ANALYSIS" },
				{ "BlueprintType", "true" },
